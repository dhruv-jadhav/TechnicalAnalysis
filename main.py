...
# To Do:
# Make system for Buy/Sell positions - done
# Make and run UnitTests on all functions
# Integrate all indicators for final buy/sell signal
# Calculate average returns from all indicators
...
stock_df = ticker.history(period='1y', interval='1h')
